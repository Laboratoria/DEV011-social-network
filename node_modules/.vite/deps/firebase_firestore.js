...
var __PRIVATE_QueryImpl = class {
  constructor(e, t = null, n = [], r2 = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r2, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.le = null, this.he = null, this.Pe = null, this.startAt, this.endAt;
  }
};
...
var BloomFilter = class {
  constructor(e, t, n) {
    ...
    this.Te = 8 * e.length - t, this.Ee = Integer.fromNumber(this.Te);
  }
  de(e, t, n) {
...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  rt(e, t) {
    ...
    return n.forEach((n2) => {
      ...
      e.mightContain(s) || (this.We(t, n2, null), r2++);
    }), r2;
  }
  it(e) {
    const t = /* @__PURE__ */ new Map();
  ...
  We(e, t, n) {
    if (!this.je(e))
      return;
    const r2 = this.ze(e);
    this.st(e, t) ? r2.Me(t, 1) : r2.xe(t), this.Qe = this.Qe.insert(t, this.ot(t).delete(e)), n && (this.qe = this.qe.insert(t, n));
  }
  removeTarget(e) {
    this.ke.delete(e);
  }
...
var __PRIVATE_IndexedDbLruDelegateImpl = class {
  ...
  Zn(e, t) {
    ...
    return n.Y({
      ...
      0 === e2 ? (i !== __PRIVATE_ListenSequence._e && t(new DocumentKey(__PRIVATE_decodeResourcePath(r2)), i), i = o, r2 = s) : i = __PRIVATE_ListenSequence._e;
    }).next(() => {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
  ...
  rr(e, t, n) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).Y({
      ...
      o && o.isEqual(i2) && (n(o, t2), o = s.hasNext() ? s.getNext() : null), o ? r3.U(__PRIVATE_dbKey(o)) : r3.done();
    }).next(() => {
      for (; o; )
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r2) {
    this.persistence = e, this.es = t, this.serializer = r2, this.ts = new SortedMap(__PRIVATE_primitiveComparator), this.ns = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.rs = /* @__PURE__ */ new Map(), this.ss = e.getRemoteDocumentCache(), this.qr = e.getTargetCache(), this.Kr = e.getBundleCache(), this.os(n);
  }
  os(e) {
...
var __PRIVATE_WebChannelConnection = class extends class __PRIVATE_RestConnection {
  ...
  vo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.bo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C2.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P2.Ro(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.si = e, this.timerId = t, this.Fo = n, this.Mo = r2, this.xo = i, this.Oo = 0, this.No = null, this.Bo = Date.now(), this.reset();
  }
  reset() {
    this.Oo = 0;
  }
  ...
  ko(e) {
    ...
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Oo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.No = this.si.enqueueAfterDelay(this.timerId, r2, () => (this.Bo = Date.now(), e())), this.Oo *= this.Mo, this.Oo < this.Fo && (this.Oo = this.Fo), this.Oo > this.xo && (this.Oo = this.xo);
  }
  Qo() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this.si = e, this.Ko = n, this.$o = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.Uo = 0, this.Wo = null, this.Go = null, this.stream = null, this.zo = new __PRIVATE_ExponentialBackoff(e, t);
  }
  jo() {
  ...
  async close(e, t) {
    this.t_(), this.n_(), this.zo.cancel(), this.Uo++, 4 !== e ? this.zo.reset() : t && t.code === C2.RESOURCE_EXHAUSTED ? (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.zo.Lo()) : t && t.code === C2.UNAUTHENTICATED && 3 !== this.state && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), null !== this.stream && (this.r_(), this.stream.close(), this.stream = null), this.state = e, await this.listener.Io(t);
  }
  r_() {
  }
  auth() {
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.D_.delete(t), r2.Ho() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.D_.size && (r2.Ho() ? r2.Zo() : __PRIVATE_canUseNetwork(n) && n.M_.set("Unknown"));
}
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r2) => {
          ...
          if (!r2)
            return;
          e2.D_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.C_.add(3), await __PRIVATE_disableNetworkInternal(n), r2 && n.M_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.C_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  if (n.queries.set(r2, s), s.listeners.push(t), t.Q_(n.onlineState), s.k_) {
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P2 = true, (_ && this._a(c, _) > 0 || a && this._a(c, a) < 0) && (o = true));
      } else
        !u && c ? (n.track({
          type: 0,
          doc: c
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      r2 && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.Ra = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.Ra) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.Ra), r2.Ra = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r2, i2), r2.pa = r2.pa.remove(s), r2.ya.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.wa.containsKey(r2.key) || __PRIVATE_removeLimboTarget(e, r2.key);
    } else
      fail();
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.Ca) {
    ...
    for (const e2 of n)
      r2.fa.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Wa = n.maxAttempts, this.zo = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Wa -= 1, this.Ga();
  }
...
function __PRIVATE_canFallbackFromIndexedDbError(e) {
  return "FirebaseError" === e.name ? e.code === C2.FAILED_PRECONDITION || e.code === C2.UNIMPLEMENTED : !("undefined" != typeof DOMException && e instanceof DOMException) || (22 === e.code || 20 === e.code || 11 === e.code);
}
...
var __PRIVATE_ParseContextImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.settings = e, this.databaseId = t, this.serializer = n, this.ignoreUndefinedProperties = r2, void 0 === i && this.Pu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
var __PRIVATE_TestingHooksSpiImpl = class {
  ...
  static get instance() {
    return be2 || (be2 = new __PRIVATE_TestingHooksSpiImpl(), function __PRIVATE_setTestingHooksSpi(e) {
      if (le)
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S2, "4.3.2", e), registerVersion(S2, "4.3.2", "esm2017");
}();
export {
